...
import { physicsRegistry, PhysicalWorld } from '@daneren2005/shared-memory-physics';
...
export type ExampleWorld = PhysicalWorld<typeof registry>;
...
export function createExampleWorld(): ExampleWorld {
	return new PhysicalWorld(registry);
}
